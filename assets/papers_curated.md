<!-- 共 120 条，其中 113 条 arXiv 链接已核验，0 条待核验；另 7 条为无 arXiv 的官方技术博客 / 模型卡 / 数据集页（GR00T N1.5、GR00T N1.6、DM0.5、Qwen3.5、LLaVA-ReCap、Nemotron-SFT、10Kh-RealOmin-OpenData） -->
<!-- 核验方式：curl http://export.arxiv.org/api/query?id_list=<ID> 取回标题并与条目标题逐条比对（2026-09-04）；GitHub / 项目页链接均经 HTTP 200 检查 -->

# Awesome StarVLA: Curated Papers
...
<tr><td colspan="2"><a href="#generalist-vla-policies">2. Generalist VLA Policies</a></td></tr>
<tr><td colspan="2"><a href="#action-heads--action-representation">3. Action Heads &amp; Action Representation</a></td></tr>
<tr><td colspan="2"><a href="#vlm-backbones-for-vla">4. VLM Backbones for VLA</a></td></tr>
<tr><td colspan="2"><a href="#representation-centric-pre-training--co-training">5. Representation-Centric Pre-training &amp; Co-training</a></td></tr>
<tr><td colspan="2"><a href="#cross-embodiment--robot-data">6. Cross-Embodiment &amp; Robot Data</a></td></tr>
<tr><td colspan="2"><a href="#world-models-for-action">7. World Models for Action (WM4A)</a></td></tr>
<tr><td colspan="2"><a href="#benchmarks--evaluation">8. Benchmarks &amp; Evaluation</a></td></tr>
<tr><td colspan="2"><a href="#rl-post-training-for-vla">9. RL Post-training for VLA</a></td></tr>
<tr><td colspan="2"><a href="#human-video--robot">10. Human Video → Robot</a></td></tr>
